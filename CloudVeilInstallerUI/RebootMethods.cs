...
namespace CloudVeilInstallerUI
{
    ...
    static class RebootMethods
    {
        /// <summary>
        /// Reboots with the specified shutdown reason.
        /// </summary>
        ...
        /// </exception>
        public static void Reboot(ShutdownReason reason)
        {
            ...
            try
            {
                ...
                // reboot
                if (!ExitWindowsEx(ExitWindows.Reboot, reason))
                {
                    throw new Win32Exception(Marshal.GetLastWin32Error(),
                        "Failed to reboot system");
                }
