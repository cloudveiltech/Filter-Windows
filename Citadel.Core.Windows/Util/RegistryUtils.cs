...
namespace Citadel.Core.Windows.Util
{
    ...
    {
        private static object m_authenticationLock = new object();
        private static object m_emailLock = new object();
        ...
        private static RegistryKey getAppRegistryKey(bool writeable = false, bool createKey = false)
        {
