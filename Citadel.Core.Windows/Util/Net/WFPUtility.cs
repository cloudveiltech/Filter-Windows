...
{
    public static class WFPUtility
    {
        // A predictable GUID based on our application's path.

        // Use this if you want to be a real jerk and make it so you have to know the precise
        // location where the filter was installed in order to be able to get that unique ID back,
        // and be able to disable the filter. Bad. Prone to too many headaches. public static Guid
        // INSTALLED_FILTER_ID = GuidUtility.Create(GuidUtility.UrlNamespace,
