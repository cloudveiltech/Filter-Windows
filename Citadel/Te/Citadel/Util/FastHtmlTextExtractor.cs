...
namespace Te.Citadel.Util
{
    ...
    public class FastHtmlTextExtractor
    {
        ...
        m_deletionDictionary = new FBitArray((uint)len);
            ...
            // Collect all non-whitespace and non-null chars into a new char array. All whitespace
            // characters are skipped and replaced with a single space char. Multiple whitespace is
            // ignored.
            var lastSpace = true;
            var extractedPos = 0;
        ...
        public bool Next(ref int pos, char[] what, char[] input)
        {
            ...
            while(pos > -1 && pos < input.Length && z < what.Length);

            return z == what.Length;
        }

        /// <summary>
        /// Skip zero or more characters starting from the given position within the input array
        /// until a non-whitespace character is discovered.
        /// </summary>
        /// <param name="pos">
        /// The position to start searching from.
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// The position within the input array that the next non-whitespace character was dicovered,
        /// or if none were discovered, a position beyond the end of the input array.
        /// </returns>
        public int SkipWhitespace(int pos, char[] input)
        {
            do
            {
