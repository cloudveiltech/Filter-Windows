/*
 * Note that this file comes from:
 * http://pinvoke.net/default.aspx/Enums/WindowsMessages.html
 *
 * Which comes from winuser.h. So, you're bound to the license terms of the Windows SDK
 * for that file, whatever they may be. Actually, it says pulled from documentation
 * on MSDN, and Microsoft permits limited copying of documentation data for
 * reasonably use without license/limitation. Look into it.
 */

using System;

namespace Te.Citadel.WinApi
{
    internal enum WindowMessages : int
    {
        ...
        /// message is sent first to the window being destroyed and then to the child windows (if
        /// any) as they are destroyed. During the processing of the message, it can be assumed that
        ...
        /// soon as one application returns zero. After processing this message, the system sends the
        ...
        /// separate user-input messages from other messages sent through the WH_JOURNALPLAYBACK Hook procedure.
        /// </summary>
        QUEUESYNC = 0x0023,
        ...
        /// window beneath the cursor. Otherwise, the message is sent to the window that has captured
        /// the mouse.
        /// </summary>
        NCHITTEST = 0x0084,
        ...
        /// X button while the cursor is in the nonclient area of a window. This message is posted to
        ...
        /// character. For example, the umlaut-O character (Ö) is generated by typing the dead key
        ...
        /// WM_CHAR, but it uses Unicode Transformation Format (UTF)-32, whereas WM_CHAR uses UTF-16.
        /// It is designed to send or post Unicode characters to ANSI windows and it can can handle
        ...
        /// <summary>
        /// An application sends the WM_UPDATEUISTATE message to change the user interface (UI) state
        /// for the specified window and all its child windows.
        /// </summary>
        ...
        /// box. By responding to this message, the dialog box can set its text and background colors
        ...
        /// The DefWindowProc function propagates the message to the window's parent. There should be
        /// no internal forwarding of the message, since DefWindowProc propagates it up the parent
        ...
        /// the child window. When the child window is being created, the system sends
        ...
        /// client window to arrange all minimized MDI child windows. It does not affect child
        ...
        /// the SC_MOVE or SC_SIZE value. The operation is complete when DefWindowProc returns. The
        /// system sends the WM_ENTERSIZEMOVE message regardless of whether the dragging of full
        /// windows is enabled.
        /// </summary>
        ...
        /// in the clipboard viewer's vertical scroll bar. The owner should scroll the clipboard
        ...
        /// has changed. Only windows that have set the flag DWM_BLURBEHIND.fTransitionOnMaximized to
        /// true will get this message.
        /// </summary>
        ...
        /// <summary>
        /// An application sends the WM_CPL_LAUNCH message to Windows Control Panel to request that a
        ...
        /// <summary>
        /// The user completed an input event (for example, pressed an application command button on
        /// the mouse or an application command key on the keyboard), and the application did not
        /// handle the WM_APPCOMMAND message generated by that input. If the Shell procedure handles
        /// the WM_COMMAND message, it should not call CallNextHookEx. See the Return Value section
        /// for more information.
        /// </summary>
        HSHELL_APPCOMMAND = 12,

        /// <summary>
        /// A window is being minimized or maximized. The system needs the coordinates of the
        /// minimized rectangle for the window.
        /// </summary>
        HSHELL_GETMINRECT = 5,
        ...
        /// <summary>
        /// The user has selected the task list. A shell application that provides a task list should
        /// return TRUE to prevent Windows from starting its task list.
        /// </summary>
        HSHELL_TASKMAN = 7,

        /// <summary>
        /// A top-level, unowned window has been created. The window exists when the system calls
        /// this hook.
        /// </summary>
        HSHELL_WINDOWCREATED = 1,

        /// <summary>
        /// A top-level, unowned window is about to be destroyed. The window still exists when the
