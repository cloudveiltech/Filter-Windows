...
.\wix-verify-bin\wix-verify.exe set Installers\SetupProjects\Product-Arm64.wxs Wix.Package.Upgrade.UpgradeVersion[1].Minimum %InstallerVersion%
.\wix-verify-bin\wix-verify.exe set Installers\SetupProjects\Product-Arm64.wxs Wix.Package.Upgrade.UpgradeVersion[2].Maximum %InstallerVersion%
.\wix-verify-bin\wix-verify.exe set Installers\SetupProjects\Product-x86.wxs Wix.Package.Upgrade.UpgradeVersion[1].Minimum %InstallerVersion%
.\wix-verify-bin\wix-verify.exe set Installers\SetupProjects\Product-x86.wxs Wix.Package.Upgrade.UpgradeVersion[2].Maximum %InstallerVersion%
.\wix-verify-bin\wix-verify.exe set Installers\SetupProjects\Product-x64.wxs Wix.Package.Upgrade.UpgradeVersion[1].Minimum %InstallerVersion%
.\wix-verify-bin\wix-verify.exe set Installers\SetupProjects\Product-x64.wxs Wix.Package.Upgrade.UpgradeVersion[2].Maximum %InstallerVersion%
